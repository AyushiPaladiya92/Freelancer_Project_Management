...
import { PlusCircleIcon, CalendarIcon, UserIcon } from '@heroicons/react/24/outline';
...
const ProjectForm = ({ onSubmit, initialProject = {} }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 bg-white shadow-md rounded-lg p-6 max-w-lg mx-auto">
      <div>
      ...
      <div>
        ...
        {project.tasks.map((task, index) => (
          <div key={task.id} className="flex space-x-2 mt-2 items-center">
            <input
              type="text"
              value={task.name}
        ...
        <button type="button" onClick={addTask} className="mt-2 text-sm text-indigo-600 hover:text-indigo-800 flex items-center">
      ...
      <div>
        ...
        {project.team.map((member, index) => (
          <div key={member.id} className="flex space-x-2 mt-2 items-center">
            <input
              type="text"
              value={member.name}
        ...
        <button type="button" onClick={addTeamMember} className="mt-2 text-sm text-indigo-600 hover:text-indigo-800 flex items-center">
